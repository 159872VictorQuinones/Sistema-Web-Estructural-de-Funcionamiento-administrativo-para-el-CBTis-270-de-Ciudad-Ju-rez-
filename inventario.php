<?php
  ...
  if($tipo_usuario_ID == PROFESOR) {
    header("Location: ./home.php");
  }

  // Obtener resultados de inventario por user_id
  $results = mysqli_query($conn, "SELECT ID, no_serie, producto, marca, modelo, descripcion, cantidad, unidad, user_id FROM inventario WHERE user_id = $user_id");
